...
judged by a creative-director pass. Every string, color, and number is verbatim in-product.
...
- **One number set** (all verified in-app): Smith Residence — 240 LF · 27 windows ·
  ...
  $56.85/LF cost). AI catches 1 sliding glass door (3 panels) + extras →
  **$23,666** customer quote (the app's own PDF sample figure).
- **Beat grid**: 22 frames (~82 BPM). Every entrance lands on a beat.
- **Brand DNA**: gold hairline w/ scroll-cue glow as recurring motif; anchor glyph
  stroke-draw; CRT modal entrance; `.pulse-once` price pulse; gold `ai-filled` sweep + AI badges.

## Timeline (absolute frames)

| Scene | Frames | Beat |
|---|---|---|
| 1. Cold open | 0–150 | Hairline draws · "ONE JOB." / "SIXTY SECONDS." · timer HUD at 0:00.0 · app assembles |
| 2. Start the quote | 150–390 | Type "Smith Residence" (timer starts f170) · tap Block Framed / 2 Story / Impact · Viwinco dropdown · recap band builds |
| 3. Live price math | 390–700 | Type 2→4→0: price counts $153.50 → $1,842.00 → $18,419.40, pulsing per keystroke · windows 27 · cost/profit cards · Full Breakdown cascade · Grand Total shimmer · "LIVE MATH. EVERY KEYSTROKE." |
...
## Fact guardrails (from the extraction pass)

No AI-accuracy %, no unlimited-reads implication below Shop, no team seats (coming soon),
no offline-mode promise, no NOA-database claim, no invented testimonials/stats.
