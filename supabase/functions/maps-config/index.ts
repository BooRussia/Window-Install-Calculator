...
// (anchorquoting.com, *.netlify.app). This endpoint is public on purpose —
// the value is destined for the browser either way.
//
...
Deno.serve(async (req) => {
  ...
  if (!key) return json({ ok: false, error: "Google Maps isn’t configured" }, 503);
